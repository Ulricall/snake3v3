...
class ReplayBuffer:
    ...
    def get_batches(self):
        ...
        log_prob_batches = np.array([_[5] for _ in sample_batch])

        return state_batches, action_batches, reward_batches, next_state_batches, done_batches, log_prob_batches
