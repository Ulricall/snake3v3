...
class ReplayBuffer:
    ...
    def push(self, state, logits, reward, next_state, done, log_prob):
        transition_tuple = (state, logits, reward, next_state, done, log_prob)
    ...
    def get_batches(self):
        ...
        action_taken_batches = np.array([_[5] for _ in sample_batch])

        return state_batches, action_batches, reward_batches, next_state_batches, done_batches, action_taken_batches
